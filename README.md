...
```
You must start by installing the database which is located in the "base de donnée" folder.
...
- ✉ Mail - `mickael.t.208@gmail.com`
- ♛ Discord - `"𝐁𝐥𝐮𝐞𝐝𝐲𝐀𝐢𝐬𝐡𝐞𝐥𝐚 ✟ | イシュタル#0002`
- ✩ Developper Name - `BluedyAishela_`